...
**ID**: 3.3
**Hypothesis**:
Mechanism: First-trigger take-profit overlay at 0.90 or 0.95 on the frozen best stop policy
...
Conflicts: requirement expects take-profit may be harmful; this directly measures rather than assumes its value

## Evaluation Info

- **Evaluation command (B_dev)**: `rtk python C:\Users\ROG\Desktop\crypto_engine_version1/.arbor/sessions/20260706_gc_market_stop_all/run_experiments.py --node 3.3 --split dev`
- **Evaluation command (B_test, do not use for routine experiments)**: `rtk python C:\Users\ROG\Desktop\crypto_engine_version1/.arbor/sessions/20260706_gc_market_stop_all/run_experiments.py --node 3.3 --split test`
