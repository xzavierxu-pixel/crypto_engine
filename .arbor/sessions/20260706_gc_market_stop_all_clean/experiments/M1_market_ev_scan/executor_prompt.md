...
**ID**: 2.2
**Hypothesis**:
Mechanism: Market-order EV threshold policy over raw_tree_blend, isotonic, and raw p_side q forecasts
...
Conflicts: none - separately changes entry order semantics with explicit timestamps

## Evaluation Info

- **Evaluation command (B_dev)**: `rtk python C:\Users\ROG\Desktop\crypto_engine_version1/.arbor/sessions/20260706_gc_market_stop_all/run_experiments.py --node 2.2 --split dev`
- **Evaluation command (B_test, do not use for routine experiments)**: `rtk python C:\Users\ROG\Desktop\crypto_engine_version1/.arbor/sessions/20260706_gc_market_stop_all/run_experiments.py --node 2.2 --split test`
