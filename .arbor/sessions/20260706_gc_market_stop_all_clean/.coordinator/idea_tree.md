...
**Insight**: All G/M/S nodes completed under the corrected evidence set. M1/M2 market orders and M3 hybrid passed; no promotion was performed.
...
**Insight**: G0 reproduced 42.43. G1-G3 all failed the required w1-w4 selection gate and did not read B_test.
...
**Insight**: Nominal Gc>=0.90 improved only one of four tune weeks, so G1 failed selection and B_test was not read.

**Result**: G1 failed w1-w4; B_test skipped.
...
**Insight**: q shrinkage did not win; shrink=0 remained best and only one of four tune weeks improved, so B_test was not read.

**Result**: G2 failed w1-w4; B_test skipped.
...
**Insight**: The empirical blend improved Gc Brier but zero of four tune weeks improved PnL, so B_test was not read.

**Result**: G3 failed w1-w4; B_test skipped.
