...
**ID**: 7
**Hypothesis**:
Mechanism: full-universe joint direction-and-bid policy using reconstructed UP/DOWN lows and EV gating instead of inheriting the legacy 70% direction acceptance mask
