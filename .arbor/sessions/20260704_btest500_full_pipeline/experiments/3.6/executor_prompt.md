...
**ID**: 3.6
**Hypothesis**:
Mechanism: settlement-safe contextual Thompson sampling over a portfolio of frozen analytic bid-policy experts
...
Conflicts: nodes 3.1-3.5 learned one global point or posterior policy and all stayed below 26.33 on B_test; this treats policy identity as the bandit action and adapts only from settlement-safe realized expert rewards
...
Save results to `results/3.6-<brief-description>/`.
