...
**ID**: 3.7
**Hypothesis**:
Mechanism: settlement-safe Bayesian exponential-weights aggregation of frozen bid experts into a posterior consensus action
...
Conflicts: node 3.6 used stochastic single-expert Thompson choices and narrowly missed the best; this replaces sampling with posterior model averaging and consensus legal bids
...
Save results to `results/3.7-<brief-description>/`.
