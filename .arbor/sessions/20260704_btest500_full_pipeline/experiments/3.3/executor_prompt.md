...
**ID**: 3.3
**Hypothesis**:
Mechanism: analytic-EV-anchored contextual action-value ensemble with lower-confidence-bound action ranking
...
Conflicts: node 3.1 standalone action-value regression collapsed to robust 17.13; this counters with analytic anchoring, ensemble uncertainty, and bounded action deviation
