...
**ID**: 3.5
**Hypothesis**:
Mechanism: hierarchical Bayesian posterior over bid rewards with partial pooling across q, side, hour, and bid cells
...
Conflicts: node 3.2 low-dimensional GP policy scored 164.30 and nodes 3.3-3.4 contextual point models scored 24.30/21.45 on B_test; this models outcome uncertainty at the action-cell level rather than optimizing global parameters or point rewards
...
Save results to `results/3.5-<brief-description>/`.
