...
Working directory: C:\Users\ROG\Desktop\arbor-worktrees\20260705_trade_l2_all-node-4.2
...
**ID**: 4.2
**Hypothesis**:
Mechanism: T7 posterior-lower-bound gate choosing between anchor and best trade/L2 challenger per segment
...
- **Evaluation command (B_dev)**: `rtk python C:\Users\ROG\Desktop\arbor-worktrees\20260705_trade_l2_all-node-4.2/.arbor/sessions/20260705_trade_l2_all/run_all_trade_l2_experiments.py --experiment 4.2 --split dev`
- **Evaluation command (B_test, do not use for routine experiments)**: `rtk python C:\Users\ROG\Desktop\arbor-worktrees\20260705_trade_l2_all-node-4.2/.arbor/sessions/20260705_trade_l2_all/run_all_trade_l2_experiments.py --experiment 4.2 --split btest`
...
Save results to `results/4.2-<brief-description>/`.
