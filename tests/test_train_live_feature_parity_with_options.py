...
def test_train_and_live_feature_paths_match_with_options() -> None:
    ...
    options = pd.DataFrame(
        {
            "timestamp": pd.date_range("2026-01-01T00:00:00Z", periods=20, freq="30min"),
            "atm_iv_near": [0.40 + index * 0.005 for index in range(20)],
            "iv_term_slope": [0.01 + index * 0.001 for index in range(20)],
        }
    )
