...
from src.features.polymarket_l2_first_minute import PolymarketL2FirstMinuteFeaturePack
...
FEATURE_PACKS: dict[str, FeaturePack] = {
    ...
    "polymarket_l2_first_minute_v1": PolymarketL2FirstMinuteFeaturePack(),
}
