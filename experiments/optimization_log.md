...
## 20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020

- Skill used: `tabular-rank-averaging-ensemble`.
- Hypothesis: rank-space blending may reduce sensitivity to CatBoost/LGBM probability scale differences while preserving the same learned ordering signal.
- Changed files: `experiments/configs/20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 features; same as current best; HTF/time features retained.
- Model settings: `model.active_plugin: catboost_lgbm_rank_blend`, `catboost_weight: 0.9770`, nested CatBoost/DART parameters copied from current best, `calibration.active_plugin: platt_logit`, `C: 0.2`.
- Config: `experiments/configs/20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020 --config experiments/configs/20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter300_rank_blend9770_dart_l1_12_platt_logit_c020/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.187836226990091`.
- Utility before / after: `0.07698289269051321` / `0.07620528771384136`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5939897698209718`.
...
## 20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020

- Skill used: model regularization probe.
- Hypothesis: a small decrease in CatBoost `l2_leaf_reg` may sharpen useful nonlinear splits while keeping the current feature/data pipeline intact.
- Changed files: `experiments/configs/20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 features; same as current best; HTF/time features retained.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, active nested CatBoost `l2_leaf_reg: 28.0`, nested DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`.
- Config: `experiments/configs/20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020 --config experiments/configs/20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter303_blend9770_cat_l2_28_platt_logit_c020/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.17785763719970468`.
- Utility before / after: `0.07698289269051321` / `0.07477967858994294`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5872919818456883`.
- Accepted count before / after: `3120` / `3305`.
- Coverage before / after: `0.40435458786936235` / `0.4283307413167444`.
- Coverage constraint satisfied: yes.
- Tests: DQC ran during training.
- Git commit: `8938847`.
- Interpretation: lower CatBoost L2 broadens acceptance and reduces accepted accuracy. Keep `l2_leaf_reg: 30.0`.
- Next step: if probing CatBoost regularization further, use stronger rather than weaker constraints or switch to another regularization dimension.

## 20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020

- Skill used: model regularization probe.
- Hypothesis: lowering CatBoost `bagging_temperature` may reduce sampling noise and improve accepted precision without changing data or thresholds.
- Changed files: `experiments/configs/20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 features; same as current best; HTF/time features retained.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, active nested CatBoost `bagging_temperature: 0.25`, nested DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`.
- Config: `experiments/configs/20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020 --config experiments/configs/20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter304_blend9770_cat_bagtemp025_platt_logit_c020/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.19027803605274402`.
- Utility before / after: `0.07698289269051321` / `0.07698289269051321`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5951923076923077`.
...
## 20260509_codex_iter313_top3_new_flow_current_blend

- Skill used: `tabular-null-importance-feature-selection`.
- Hypothesis: adding only the top three discovered non-VWAP, non-30m second-level flow/path features may avoid the precision dilution from the top-12 expansion.
- Changed files: `experiments/configs/20260509_codex_iter313_top3_new_flow_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260509_codex_iter313_top3_new_flow_split`.
- Feature set: 519 features; current best 516 features plus `sl_mirror_signed_volume_1s`, `sl_mirror_signed_quote_volume_1s`, and `sl_mirror_return_slope_5s`; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260509_codex_iter313_top3_new_flow_split/top3_new_flow_summary.json`.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, nested CatBoost/DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`.
- Config: `experiments/configs/20260509_codex_iter313_top3_new_flow_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260509_codex_iter313_top3_new_flow_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter313_top3_new_flow_current_blend --config experiments/configs/20260509_codex_iter313_top3_new_flow_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter313_top3_new_flow_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.17992577629463077`.
- Utility before / after: `0.07698289269051321` / `0.07439087610160706`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5893524283935243`.
- Accepted count before / after: `3120` / `3212`.
...
## 20260509_codex_iter324_blend9770_purge5_platt_logit_c020

- Skill used: validation-discipline data processing.
- Hypothesis: increasing `purge_rows` from 1 to 5 may reduce near-boundary temporal overlap and improve validation reliability without changing labels, features, or thresholds.
- Changed files: `experiments/configs/20260509_codex_iter324_blend9770_purge5_platt_logit_c020.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 features; same as current best; HTF/time features retained.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, nested CatBoost/DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`, command-line `--purge-rows 5`.
- Config: `experiments/configs/20260509_codex_iter324_blend9770_purge5_platt_logit_c020.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter324_blend9770_purge5_platt_logit_c020 --config experiments/configs/20260509_codex_iter324_blend9770_purge5_platt_logit_c020.yaml --horizon 5m --train-window-days 75 --validation-window-days 30 --purge-rows 5`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter324_blend9770_purge5_platt_logit_c020/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.19027803605274402`.
- Utility before / after: `0.07698289269051321` / `0.07698289269051321`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5951923076923077`.
...
## 20260509_codex_iter326_blend9770_pos_rebalance_095_105

- Skill used: `timeseries-class-weighted-multiclass-logloss`.
- Hypothesis: a small positive-class emphasis may improve confidence on the dominant UP side and raise accepted precision without changing threshold policy.
- Changed files: `experiments/configs/20260509_codex_iter326_blend9770_pos_rebalance_095_105.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 features; same as current best; HTF/time features retained.
- Model settings: current best logit blend with `catboost_weight: 0.9770`; active CatBoost adds `class_weights: [0.95, 1.05]`; active DART uses `scale_pos_weight: 1.1052631579`; `calibration.active_plugin: platt_logit`, `C: 0.2`.
- Config: `experiments/configs/20260509_codex_iter326_blend9770_pos_rebalance_095_105.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260509_codex_iter326_blend9770_pos_rebalance_095_105 --config experiments/configs/20260509_codex_iter326_blend9770_pos_rebalance_095_105.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260509_codex_iter326_blend9770_pos_rebalance_095_105/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.17167690775092667`.
- Utility before / after: `0.07698289269051321` / `0.07011404872991184`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5868378812199037`.
- Accepted count before / after: `3120` / `3115`.
- Coverage before / after: `0.40435458786936235` / `0.4037065837221358`.
- Coverage constraint satisfied: yes.
- Tests: DQC ran during training.
...
## 20260510_codex_iter330_best516_plus_options_current_blend

- Skill used: local derivative data enrichment.
- Hypothesis: options-only context may add volatility-regime information without the noisier funding/basis/OI derivative columns.
- Changed files: `experiments/configs/20260510_codex_iter330_best516_plus_options_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter330_best516_plus_options_split`.
- Feature set: 521 features; current best 516 features plus `atm_iv_near`, `iv_term_slope`, `iv_change_1h`, `iv_zscore`, and `iv_regime`; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter330_best516_plus_options_split/best516_plus_options_summary.json`.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, nested CatBoost/DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`; `derivatives.enabled: true`.
- Config: `experiments/configs/20260510_codex_iter330_best516_plus_options_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter330_best516_plus_options_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter330_best516_plus_options_current_blend --config experiments/configs/20260510_codex_iter330_best516_plus_options_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30 --derivatives-path-mode archive`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter330_best516_plus_options_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.16340658717054235`.
- Utility before / after: `0.07698289269051321` / `0.06829963711767752`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5817561278312131`.
- Accepted count before / after: `3120` / `3223`.
...
## 20260510_codex_iter333_best516_plus_oi_current_blend

- Skill used: `tabular-collinear-feature-removal` for source-isolation framing; local derivative data enrichment for cached split construction.
- Hypothesis: OI level/change features may capture positioning expansion or unwind pressure that improves selective precision.
- Changed files: `experiments/configs/20260510_codex_iter333_best516_plus_oi_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter333_best516_plus_oi_split`.
- Feature set: 524 features; current best 516 features plus eight OI columns; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter333_best516_plus_oi_split/best516_plus_oi_summary.json`.
- Model settings: current best logit blend with `catboost_weight: 0.9770`, nested CatBoost/DART unchanged, `calibration.active_plugin: platt_logit`, `C: 0.2`; `derivatives.enabled: true`.
- Config: `experiments/configs/20260510_codex_iter333_best516_plus_oi_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter333_best516_plus_oi_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter333_best516_plus_oi_current_blend --config experiments/configs/20260510_codex_iter333_best516_plus_oi_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30 --derivatives-path-mode archive`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter333_best516_plus_oi_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.1649566274086236`.
- Utility before / after: `0.07698289269051321` / `0.07011404872991185`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5812556323220186`.
- Accepted count before / after: `3120` / `3329`.
...
## 20260510_codex_iter340_active_cat_l2_35_current_blend

- Skill used: model regularization probe.
- Hypothesis: increasing active nested CatBoost `l2_leaf_reg` from `30` to `35` may improve accepted precision if the current best is still slightly overfit.
- Changed files: `experiments/configs/20260510_codex_iter340_active_cat_l2_35_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 current best features; HTF/time features retained.
- Model settings: current best logit blend except active nested `catboost_lgbm_logit_blend.catboost.l2_leaf_reg: 30.0 -> 35.0`; DART and calibration unchanged.
- Config: `experiments/configs/20260510_codex_iter340_active_cat_l2_35_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter340_active_cat_l2_35_current_blend --config experiments/configs/20260510_codex_iter340_active_cat_l2_35_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter340_active_cat_l2_35_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.18247679489010074`.
- Utility before / after: `0.07698289269051321` / `0.07581648522550546`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.590027700831025`.
- Accepted count before / after: `3120` / `3249`.
- Coverage before / after: `0.40435458786936235` / `0.42107309486780714`.
- Coverage constraint satisfied: yes.
- Tests: DQC ran during training.
...
## 20260510_codex_iter342_platt_c030_current_blend

- Skill used: `tabular-logit-transform-stacking`.
- Hypothesis: weaker Platt/logit calibration regularization (`C: 0.2 -> 0.3`) may preserve more probability separation and improve selective acceptance.
- Changed files: `experiments/configs/20260510_codex_iter342_platt_c030_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split`.
- Feature set: 516 current best features; HTF/time features retained.
- Model settings: current best logit blend unchanged; calibration `platt_logit.C: 0.2 -> 0.3`.
- Config: `experiments/configs/20260510_codex_iter342_platt_c030_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260508_codex_iter43_train75_drop_sl_vwap_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter342_platt_c030_current_blend --config experiments/configs/20260510_codex_iter342_platt_c030_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter342_platt_c030_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.18475933518660062`.
- Utility before / after: `0.07698289269051321` / `0.07542768273716956`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5922637920101459`.
- Accepted count before / after: `3120` / `3154`.
...
## 20260510_codex_iter356_full90_top800_protected_current_blend

- Skill used: `tabular-recursive-feature-elimination` adapted as a single-pass full-profile importance screen.
- Hypothesis: using more downloaded data with a filtered top800 subset from the 90-day full-profile run may keep useful wide-context features while removing the lowest-importance noise.
- Changed files: `experiments/configs/20260510_codex_iter356_full90_top800_protected_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter356_full90_top800_protected_split`.
- Feature set: 813 features; iter351 full-profile gain top800 plus protected HTF and hour/minute time features.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter356_full90_top800_protected_split/full90_top800_protected_summary.json`.
- Model settings: current best logit blend, DART, and calibration unchanged.
- Config: `experiments/configs/20260510_codex_iter356_full90_top800_protected_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter356_full90_top800_protected_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter356_full90_top800_protected_current_blend --config experiments/configs/20260510_codex_iter356_full90_top800_protected_current_blend.yaml --horizon 5m --train-window-days 90 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter356_full90_top800_protected_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.16986680112611244`.
- Utility before / after: `0.07698289269051321` / `0.07452047693105233`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5811001410437235`.
- Accepted count before / after: `3120` / `3545`.
...
## 20260510_codex_iter362_htf_micro_cross_top2_current_blend

- Skill used: `tabular-polynomial-interaction-features` with feature-importance-guided pruning.
- Hypothesis: keeping only the top two gain-ranked HTF x microstructure cross terms from iter361 may preserve the useful context while removing lower-value interaction noise.
- Changed files: `experiments/configs/20260510_codex_iter362_htf_micro_cross_top2_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter362_htf_micro_cross_top2_split`.
- Feature set: 518 features; current best 516 features plus two HTF x microstructure cross features; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter362_htf_micro_cross_top2_split/htf_micro_cross_top2_summary.json`.
- Model settings: current best logit blend, DART, and calibration unchanged.
- Config: `experiments/configs/20260510_codex_iter362_htf_micro_cross_top2_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter362_htf_micro_cross_top2_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter362_htf_micro_cross_top2_current_blend --config experiments/configs/20260510_codex_iter362_htf_micro_cross_top2_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter362_htf_micro_cross_top2_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.16892546699191496`.
- Utility before / after: `0.07698289269051321` / `0.07205806117159154`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.582639714625446`.
- Accepted count before / after: `3120` / `3364`.
...
## 20260510_codex_iter364_top10_percentile_rank_current_blend

- Skill used: `tabular-rank-calibrated-blending` rank-space idea adapted to feature engineering.
- Hypothesis: development-fitted percentile-rank transforms of the strongest current-best features may stabilize feature scale and improve accepted precision while preserving the original raw features.
- Changed files: `experiments/configs/20260510_codex_iter364_top10_percentile_rank_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_split`.
- Feature set: 526 features; current best 516 features plus development-fitted percentile-rank transforms for the top 10 current-best gain features; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_split/top10_percentile_rank_summary.json`; quantiles: `artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_split/top10_percentile_rank_quantiles.json`.
- Model settings: current best logit blend, DART, and calibration unchanged.
- Config: `experiments/configs/20260510_codex_iter364_top10_percentile_rank_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_current_blend --config experiments/configs/20260510_codex_iter364_top10_percentile_rank_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter364_top10_percentile_rank_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.1778664601444009`.
- Utility before / after: `0.07698289269051321` / `0.0734836702954899`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5885660731021556`.
- Accepted count before / after: `3120` / `3201`.
...
## 20260510_codex_iter393_nullimp_drop20_current_blend

- Skill used: `tabular-null-importance-feature-selection`.
- Hypothesis: removing features whose development gain does not beat shuffled-target null gain may reduce noisy splits while preserving required HTF/time context.
- Changed files: `experiments/configs/20260510_codex_iter393_nullimp_drop20_current_blend.yaml`, `experiments/optimization_log.md`.
- Cached split: `artifacts/data_v2/experiments/20260510_codex_iter393_nullimp_drop20_split`.
- Feature set: 496 features; current best 516 features minus the 20 worst non-protected null-importance candidates; HTF/time features retained.
- Split summary: `artifacts/data_v2/experiments/20260510_codex_iter393_nullimp_drop20_split/nullimp_drop20_summary.json`.
- Feature selection record: `artifacts/data_v2/experiments/20260510_codex_null_importance_current516.json`.
- Model settings: current best logit blend, DART, and calibration unchanged.
- Config: `experiments/configs/20260510_codex_iter393_nullimp_drop20_current_blend.yaml`.
- Evaluation command: `rtk python scripts/model/train_model.py --cached-split-dir artifacts/data_v2/experiments/20260510_codex_iter393_nullimp_drop20_split --output-dir artifacts/data_v2/experiments/20260510_codex_iter393_nullimp_drop20_current_blend --config experiments/configs/20260510_codex_iter393_nullimp_drop20_current_blend.yaml --horizon 5m --train-window-days 75 --validation-window-days 30`.
- Evaluation report: `artifacts/data_v2/experiments/20260510_codex_iter393_nullimp_drop20_current_blend/metrics.json`.
- Score before: `0.19027803605274402`.
- Score after: `0.18106103541939972`.
- Utility before / after: `0.07698289269051321` / `0.07840850181441159`.
- Accepted accuracy before / after: `0.5951923076923077` / `0.5864532723635324`.
- Accepted count before / after: `3120` / `3499`.
